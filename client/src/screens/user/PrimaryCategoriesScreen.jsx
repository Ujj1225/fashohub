...
import PrimaryCategoriesFilter from "../../components/filters/PrimaryCategoriesFilter";
import Footer from "../../components/Footer";

const PrimaryCategoriesScreen = () => {
  ...
  const { data, error, isLoading } = useGetPrimaryCategoryProductsQuery({
    primary,
    sort: sortCriteria,
  ...
  return (
    ...
    <div className="pb-4">
      <div className="p-4">
        ...
        &nbsp; /&nbsp;
        <Link to={`/${primary}`} className="text-sm font-bold hover:underline">
      ...
      <div className="flex">
        ...
        <div className="w-[85%] sm:w-full">
          {isLoading && (
            <div className="grid grid-cols-5 gap-y-8 p-5 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:p-3 sm:gap-x-4 xsm:grid-cols-1">
...
export default PrimaryCategoriesScreen;
