...
import { useGetTertiaryCategoryProductQuery } from "../../store/slices/productsApiSlice";
import ProductCard from "../../components/ProductCard";
import SkeletonProductCard from "../../components/SkeletonProductCard";
import { Divider, Select } from "@mantine/core";
import { debounce } from "lodash";
import TertiaryCategoriesFilter from "../../components/filters/TertiaryCategoriesFilter";
import PriceRangeFilter from "../../components/filters/PriceRangeFilter";
import DiscountFilter from "../../components/filters/DiscountFilter";
import Footer from "../../components/Footer";

const TertiaryCategoryScreen = () => {
  ...
  const { data, error, isLoading } = useGetTertiaryCategoryProductQuery({
    primary,
    secondary,
    tertiary,
    sort: sortCriteria,
    ...
    <>
      <div className="pb-4">
        <div className="p-4">
          ...
          >
            {tertiary.replace(/-/g, " ").toUpperCase()}
          </Link>
        ...
        <div className="flex">
          ...
          <div className="w-[85%] sm:w-full">
            {isLoading && (
              <div className="grid grid-cols-5 gap-x-10 gap-y-8 p-10 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:p-3 sm:gap-x-4 xsm:grid-cols-1">
...
export default TertiaryCategoryScreen;
